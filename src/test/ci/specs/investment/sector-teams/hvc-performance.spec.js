...
describe( 'Investment Sector Team performance Page', function(){
	...
	beforeAll( function( done ){
		...
		fetch( '/investment/sector-teams/1/hvc-performance/' ).then( takeScreenshot( 'investment_sector_team_hvc_performance' ) ).then( done );
	} );

	accessibilityCheck( 'investment_sector_team_hvc_performance' );
