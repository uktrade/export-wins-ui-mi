...
describe( 'Investment Sector Team performance Page', function(){
	...
	beforeAll( function( done ){
		...
		fetch( '/investment/sector-teams/1/' ).then( takeScreenshot( 'investment_sector_team_non_hvc_performance' ) ).then( done );
	} );

	accessibilityCheck( 'investment_sector_team_non_hvc_performance' );
