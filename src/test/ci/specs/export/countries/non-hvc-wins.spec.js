...
describe( 'The Country non HVC wins page', function(){

	beforeAll( function( done ){

		fetch( '/countries/US/non-hvc-wins/' ).then( takeScreenshot( 'countries_non-hvc-wins' ) ).then( done );
	} );

	accessibilityCheck( 'countries_non-hvc-wins' );
