...
describe( 'Creating a tracker', function(){
	...
	describe( 'When an analytics id is in the config', function(){
		...
		describe( 'When there is a user in the req', function(){
			...
			describe( 'When the user is internal', function(){
				...
				describe( 'When there is NOT an id cookie', function(){
			...
			describe( 'When the user is NOT internal', function(){

				describe( 'When there is an id cookie', function(){

					describe( 'If the id cookie matches the pattern', function(){
					...
					describe( 'If the id cookie does not match the pattern', function(){
