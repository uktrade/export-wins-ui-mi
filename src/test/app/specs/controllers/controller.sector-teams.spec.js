...
describe( 'Sector Teams controller', function(){
	...
	describe( 'Overview', function(){
		...
		it( 'Should get the overview data and render the correct view', function( done ){
			...
			interceptBackend.getStub( `/mi/sector_teams/overview/?year=${ year }`, 200, '/sector_teams/overview' );
	...
	describe( 'Team', function(){
		...
		it( 'Should get the team data and render the correct view', function( done ){
			...
			interceptBackend.getStub( `/mi/sector_teams/${ teamId }/?year=${ year }`, 200, '/sector_teams/sector_team' );
			interceptBackend.getStub( `/mi/sector_teams/${ teamId }/months/?year=${ year }`, 200, '/sector_teams/months' );
			interceptBackend.getStub( `/mi/sector_teams/${ teamId }/campaigns/?year=${ year }`, 200, '/sector_teams/campaigns' );
			interceptBackend.getStub( `/mi/sector_teams/${ teamId }/top_non_hvcs/?year=${ year }`, 200, '/sector_teams/top_non_hvcs' );
